...
func main() {
	...
	cmd = &ffcli.Command{
		Name:       fmt.Sprintf("Portal gateway, build at %s", BuildTime),
...
func initServeCmd() {
	...
	serveCmdFS.StringVar(&(serveCmdOptions.ConfigFilePath), "config", "config/portal.g/serve.yml", "alternative config file path")
